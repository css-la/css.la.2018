...
const IndexPage = () => (
  <main>
    ...
    <p>Los Angeles' premier (and brand new!) group for CSS and front-end enthusiasts. So far, CSS.la consists of a monthly study group through Learn Teach Code, a fantastic and supportive community of developers all over the Los Angeles area.</p>

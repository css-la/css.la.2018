...
const IndexPage = () => (
  <main>
    ...
    <p>Our first meetup is <strong>April 25, 2018 at 6:30pm</strong> in Los Feliz, and the theme will be "CSS and Browser Mechanics". After a brief presentation from <a href="https://twitter.com/laras126">Lara</a>, we'll apply our newfound knowledge and work together on the CSS for this site (even though it's pretty amazing already 🤔).</p>

...
const IndexPage = () => (
  ...
  <g>
    ...
    <p>Have a question, concern, or would you like to help with CSS.la? Send an email to Scott Gruber @ <a href="mailto:hello@scottgruber.me">hello at scottgruber dot me</a>.</p>
  </main>
)
